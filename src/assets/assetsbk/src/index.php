                ...
                <div class="header">
                    <nav class="navbar navbar-expand-md navbar-light px-lg-0">
                        <a class="navbar-brand pr-0 pr-md-3 mr-0" href="#">
                            <img src="../images/landingpage/logo.png" class="brand-img" alt="logo">
                        </a>
                        <ul class="navbar-nav">
                    ...
                    <div class="row header-banner align-items-start">
                        <div class="col-lg-5 mt-5 pt-0 pt-lg-5">
                            ...
                            <div class="d-flex align-items-center mt-4 justify-content-center justify-content-lg-start">
                                <img src="../images/landingpage/brand-logos.png" alt="logos" />
                            </div>
                        ...
                        <div class="col-lg-7">
                            <img class="banner-img mt-md-4 mt-lg-0" src="../images/landingpage/banne-img.png" alt="db">
                        </div>
                    </div>
                </div>
                <!-- End Header -->
            ...
            <section>
                <div class="container bg-section py-5 my-0 my-lg-4">
                    <div class="row mt-0 mt-md-5">
                        <div class="col-lg-8">
                            <img src="../images/landingpage/section-img.png" class="img-fluid pr-4 mr-2">
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="container">
                    <div class="row mt-5 bg-section-v2">
                        ...
                        <div class="col-lg-7 pl-4">
                            <img src="../images/landingpage/right-img.png" class="feature-img ml-3 pl-1">
                        </div>
                    </div>
                </div>
            </section>
